(function () {
    ...
    var ractive = new Ractive({
        ...
        newEmployeeSelect: function () {
            ...
            var userPermissionURL = baseUrl + "user/api_employee_permission/" + employee.id;
            var rolePermissionURL = baseUrl + "user/api_role_permission/" + employee.job_title_id;
            var rawPermissionURL = baseUrl + "user/api_raw_permissions";
        ...
        newSectionSelect: function () {
            ...
            var url = baseUrl + "user/api_fetch_employees/" + clazzId;
            fetch(url, {
                method: 'GET',
                credentials: 'same-origin'
            }).then(function (response) {
        ...
        showPermission: function (title, list) {
            ...
            var url = baseUrl + "user/api_set_user_permission/" + employeeId;
