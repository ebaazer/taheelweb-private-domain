    ...
    init:function(){
        ...
        e = $(".m-datatable").mDatatable({
            ...
            columns:[
                ...
                {field:"Status", title:"Status", template:function(e){var t = {
                            1:{title:"The_case_study_was_not_created", class:"m-badge--brand"}, 
                            2:{title:"The_case_study_was_created", class:" m-badge--brand"}, 
                ...
                {field:"Type", title:"Type", template:function(e){var t = {
                ...
                $("#m_form_status").on("change", function(){
                    ...
                    $("#m_form_type").on("change", function(){
                        e.search($(this).val().toLowerCase(), "Type")}), $("#m_form_status, #m_form_type").selectpicker()
