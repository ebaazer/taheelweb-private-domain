this.Element && function (t) {
    t.matches = t.matches || t.matchesSelector || t.webkitMatchesSelector || t.msMatchesSelector || function (t) {
        for (var e = (this.parentNode || this.document).querySelectorAll(t),
                a = -1; e[++a] && e[a] != this; )
            ;
        return!!e[a]
    }
        ...
        function () {
            for (var t = 0,
                    e = ["webkit",
                        "moz"],
                    a = 0; a < e.length && !window.requestAnimationFrame; ++a)
    ...
    t.hasOwnProperty("prepend") || Object.defineProperty(t, "prepend", {configurable: !0, enumerable: !0, writable: !0, value: function () {
...
var mUtil = function () {
    ...
    return{init: function (t) {
            ...
            for (var e, a, n = mUtil.get(t); n && n !== document; ) {
                if (("absolute" === (e = mUtil.css(n, "position")) || "relative" === e || "fixed" === e) && (a = parseInt(mUtil.css(n, "z-index")), !isNaN(a) && 0 !== a))
                    return a;
                n = n.parentNode
            }
            return null
            ...
            if (window.CustomEvent)
                var n = new CustomEvent(e, {detail: a});
            else
            ...
            return t = mUtil.get(t), {set: function (e, a) {
            ...
            var e, a;
            if (t = mUtil.get(t))
                return t.getClientRects().length ? (e = t.getBoundingClientRect(), a = t.ownerDocument.defaultView, {top: e.top + a.pageYOffset, left: e.left + a.pageXOffset}) : {top: 0, left: 0}
        }, height: function (t) {
            ...
            if (t instanceof HTMLElement != !1)
                return t.getAttribute("m-hidden-" + e) && !1 !== a ? parseFloat(t.getAttribute("m-hidden-" + e)) : (t.style.cssText = "position: absolute; visibility: hidden; display: block;", "width" == e ? n = t.offsetWidth : "height" == e && (n = t.offsetHeight), t.style.cssText = "", t.setAttribute("m-hidden-" + e, n), parseFloat(n))
...
var mApp = function () {
    ...
    return{init: function (e) {
            ...
            jQuery.event.special.touchstart = {setup: function (t, e, a) {
                ...
                }}, jQuery.event.special.touchmove = {setup: function (t, e, a) {
                ...
                }}, jQuery.event.special.wheel = {setup: function (t, e, a) {
                ...
                var t = $(this);
                mUtil.scrollerInit(this, {disableForMobile: !0, handleWindowResize: !0, height: function () {
            ...
            if ("spinner" == (e = $.extend(!0, {opacity: .03, overlayColor: "#000000", state: "brand", type: "loader", size: "lg", centerX: !0, centerY: !0, message: "", shadow: !0, width: "auto"}, e)).type ? o = '<div class="m-spinner ' + (a = e.skin ? "m-spinner--skin-" + e.skin : "") + " " + (n = e.state ? "m-spinner--" + e.state : "") + '"></div' : (a = e.skin ? "m-loader--skin-" + e.skin : "", n = e.state ? "m-loader--" + e.state : "", size = e.size ? "m-loader--" + e.size : "", o = '<div class="m-loader ' + a + " " + n + " " + size + '"></div'), e.message && e.message.length > 0) {
                ...
                html = o;
            var r = {message: html, centerY: e.centerY, centerX: e.centerX, css: {top: "30%", left: "50%", border: "0", padding: "0", backgroundColor: "none", width: e.width}, overlayCSS: {backgroundColor: e.overlayColor, opacity: e.opacity, cursor: "wait", zIndex: "10"}, onUnblock: function () {
...
$(document).ready(function () {
    ...
    t.fn.mDatatable = function (n) {
        if (0 !== t(this).length) {
            ...
            var i = {isInit: !1, offset: 110, stateId: "meta", ajaxParams: {}, init: function (e) {
                    var a = !1;
                    ...
                    i.setupSubDatatable.call(), i.setupSystemColumn.call(), i.setupHover.call(), void 0 === n.detail && 1 === i.getDepth() && i.lockTable.call(), i.columnHide.call(), i.resetScroll(), i.isInit || (t(o).trigger("m-datatable--on-init", {table: t(o.wrap).attr("id"), options: n}), i.isInit = !0), t(o).trigger("m-datatable--on-layout-updated", {table: t(o.wrap).attr("id")})
                }, lockTable: function () {
                    var e = {lockEnabled: !1, init: function () {
                                ...
                                0 === t(this).find(".m-datatable__lock").length && t(this).ready(function () {
                                    !function (a) {
                                        if (t(a).find(".m-datatable__lock").length > 0)
                                            ...
                                            var n = t("<div/>").addClass("m-datatable__lock m-datatable__lock--left"), l = t("<div/>").addClass("m-datatable__lock m-datatable__lock--scroll"), r = t("<div/>").addClass("m-datatable__lock m-datatable__lock--right");
                    ...
                    var a = {scrollable: null, tableLocked: null, mcsOptions: {scrollInertia: 0, autoDraggerLength: !0, autoHideScrollbar: !0, autoExpandScrollbar: !1, alwaysShowScrollbar: 0, mouseWheel: {scrollAmount: 120, preventDefault: !1}, advanced: {updateOnContentResize: !0, autoExpandHorizontalScroll: !0}, theme: "minimal-dark"}, init: function () {
                    ...
                    var l = {meta: null, pager: null, paginateEvent: null, pagerLayout: {pagination: null, info: null}, callback: null, init: function (e) {
                            ...
                            var u = t("<select/>").addClass("selectpicker m-datatable__pager-size").attr("title", i.getOption("translate.toolbar.pagination.items.default.select")).attr("data-width", "70px").val(l.meta.perpage).on("change", l.updatePerpage).prependTo(l.pagerLayout.info), p = i.getOption("toolbar.items.pagination.pageSizeSelect");
                            ...
                            t(o).off(l.paginateEvent).on(l.paginateEvent, function (e, a) {
                                ...
                                }), t(l.pager).find(".m-datatable__pager-nav").show(), a.pages <= 1 && t(l.pager).find(".m-datatable__pager-nav").hide(), i.setDataSourceParam("pagination", {page: l.meta.page, pages: l.meta.pages, perpage: l.meta.perpage, total: l.meta.total}), t(l.pager).find("select.m-datatable__pager-size").val(a.perpage).attr("data-selected", a.perpage), t(o.table).find('.m-checkbox > [type="checkbox"]').prop("checked", !1), t(o.table).find(".m-datatable__row--active").removeClass("m-datatable__row--active"), l.updateInfo.call(), l.pagingBreakpoint.call()
                            })
                        }, updateInfo: function () {
                            var e = Math.max(l.meta.perpage * (l.meta.page - 1) + 1, 1), a = Math.min(e + l.meta.perpage - 1, l.meta.total);
                            t(l.pager).find(".m-datatable__pager-info").find(".m-datatable__pager-detail").html(i.dataPlaceholder(i.getOption("translate.toolbar.pagination.items.info"), {start: e, end: -1 === l.meta.perpage ? l.meta.total : a, pageSize: -1 === l.meta.perpage || l.meta.perpage >= l.meta.total ? l.meta.total : l.meta.perpage, total: l.meta.total}))
                            ...
                            var e = t(o.table).siblings(".m-datatable__pager").find(".m-datatable__pager-nav"), a = t(e).find(".m-datatable__pager-link--more-prev"), n = t(e).find(".m-datatable__pager-link--more-next"), r = t(e).find(".m-datatable__pager-link--first"), s = t(e).find(".m-datatable__pager-link--prev"), d = t(e).find(".m-datatable__pager-link--next"), c = t(e).find(".m-datatable__pager-link--last"), m = t(e).find(".m-datatable__pager-link-number"), u = Math.max(t(m).first().data("page") - 1, 1);
                    ...
                    if (t) {
                        ...
                        i.isSpinning = !1, void 0 !== a && a.unblock(o)
                    ...
                    var e = function (e) {
                        ...
                        if (t(o).hasClass("m-datatable__row-detail"))
                            t(this).find("i").removeClass(i.getOption("layout.icons.rowDetail.expand")).addClass(i.getOption("layout.icons.rowDetail.collapse")), t(o).remove();
                        else {
                    ...
                    if (void 0 === n && (n = "AND"), "object" != typeof a)
                        return e;
                    if (n = n.toUpperCase(), -1 === t.inArray(n, ["AND", "OR", "NOT"]))
                        return[];
                    ...
                    o.API.params = t.extend({}, {pagination: {page: 1, perpage: i.getOption("data.pageSize")}, sort: i.getDefaultSortColumn(), query: {}}, o.API.params, i.stateGet(i.stateId)), o.API.params = i.extendObj(o.API.params, e, a), i.stateKeep(i.stateId, o.API.params)
                }, getDataSourceParam: function (e) {
                    return o.API.params = t.extend({}, {pagination: {page: 1, perpage: i.getOption("data.pageSize")}, sort: i.getDefaultSortColumn(), query: {}}, o.API.params, i.stateGet(i.stateId)), "string" == typeof e ? i.getObject(e, o.API.params) : o.API.params
            ...
            if (t.each(i, function (t, e) {
                ...
                if ("string" == typeof n) {
                    ...
                    o.data("mDatatable") || t(this).hasClass("m-datatable--loaded") || (o.dataSet = null, o.textAlign = {left: "m-datatable__cell--left", center: "m-datatable__cell--center", right: "m-datatable__cell--right"}, n = t.extend(!0, {}, t.fn.mDatatable.defaults, n), o.options = n, i.init.apply(this, [n]), t(o.wrap).data("mDatatable", o));
            else
                void 0 === (o = t(this).data("mDatatable")) && t.error("mDatatable not initialized"), n = o.options;
            return o
        }
...
var mDropdown = function (t, e) {
    ...
    if (n) {
        var i = {toggle: "click", hoverTimeout: 300, skin: "light", height: "auto", maxHeight: !1, minHeight: !1, persistent: !1, mobileOverlay: !0}, l = {construct: function (t) {
...
var mHeader = function (t, e) {
    var a = this, n = mUtil.get(t), o = mUtil.get("body");
    if (void 0 !== n) {
        var i = {classic: !1, offset: {mobile: 150, desktop: 200}, minimize: {mobile: !1, desktop: !1}}, l = {construct: function (t) {
    ...
    if (o) {
        var l = {accordion: {slideSpeed: 200, autoScroll: !1, autoScrollSpeed: 1200, expandAll: !0}, dropdown: {timeout: 500}}, r = {construct: function (t) {
...
var mOffcanvas = function (t, e) {
    ...
    var a = this, n = mUtil.get(t), o = mUtil.get("body");
    if (n) {
        var l = {bodyToggleSpeed: 400, tooltips: !0, tools: {toggle: {collapse: "Collapse", expand: "Expand"}, reload: "Reload", remove: "Remove", fullscreen: {on: "Fullscreen", off: "Exit Fullscreen"}}, sticky: {offset: 300, zIndex: 98}}, r = {construct: function (t) {
                ...
                if (a.options.tooltips) {
                    var t = mUtil.hasClass(n, "m-portlet--collapse") || mUtil.hasClass(n, "m-portlet--collapsed"), e = mUtil.hasClass(o, "m-portlet--fullscreen") && mUtil.hasClass(n, "m-portlet--fullscreen"), i = mUtil.find(a.head, "[m-portlet-tool=remove]");
                    if (i) {
                        var l = e ? "bottom" : "top", r = new Tooltip(i, {title: a.options.tools.remove, placement: l, offset: e ? "0,10px,0,0" : "0,5px", trigger: "hover", template: '<div class="m-tooltip m-tooltip--portlet tooltip bs-tooltip-' + l + '" role="tooltip">                            <div class="tooltip-arrow arrow"></div>                            <div class="tooltip-inner"></div>                        </div>'});
                ...
                if ("off" === t || mUtil.hasClass(o, "m-portlet--fullscreen") && mUtil.hasClass(n, "m-portlet--fullscreen"))
                    r.eventTrigger("beforeFullscreenOff"), mUtil.removeClass(o, "m-portlet--fullscreen"), mUtil.removeClass(n, "m-portlet--fullscreen"), r.removeTooltips(), r.setupTooltips(), a.foot && (mUtil.css(a.body, "margin-bottom", ""), mUtil.css(a.foot, "margin-top", "")), r.eventTrigger("afterFullscreenOff");
                else {
    ...
    if (n) {
        var l = {mode: "default", minLength: 1, maxHeight: 300, requestTimeout: 200, inputTarget: "m_quicksearch_input", iconCloseTarget: "m_quicksearch_close", iconCancelTarget: "m_quicksearch_cancel", iconSearchTarget: "m_quicksearch_search", spinnerClass: "m-loader m-loader--skin-light m-loader--right", hasResultClass: "m-list-search--has-result", templates: {error: '<div class="m-search-results m-search-results--skin-light"><span class="m-search-result__message">{{message}}</div></div>'}}, r = {construct: function (t) {
                ...
                if (a.query = a.input.value, 0 === a.query.length && (r.handleCancelIconVisibility("on"), mUtil.removeClass(n, a.options.hasResultClass), mUtil.removeClass(a.form, a.options.spinnerClass)), !(a.query.length < a.options.minLength || 1 == a.processing))
                    return a.requestTimeout && clearTimeout(a.requestTimeout), a.requestTimeout = !1, a.requestTimeout = setTimeout(function () {
    ...
    var a = this, n = mUtil.get(t), o = mUtil.get("body");
    if (n) {
        var i = {offset: 300, speed: 600}, l = {construct: function (t) {
    ...
    mUtil.get("body");
    if (n) {
        var o = {togglerState: "", targetState: ""}, l = {construct: function (t) {
    ...
    mUtil.get("body");
    if (n) {
        var o = {startStep: 1, manualStepForward: !1}, l = {construct: function (t) {
                ...
                if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
                    var e;
                    if (e = (t = t ? parseInt(t) : l.getNextStep()) > a.currentStep ? l.eventTrigger("beforeNext") : l.eventTrigger("beforePrev"), !0 !== a.stopped)
                        return!1 !== e && (l.eventTrigger("beforeChange"), a.currentStep = t, l.updateUI(), l.eventTrigger("change")), t > a.startStep ? l.eventTrigger("afterNext") : l.eventTrigger("afterPrev"), a;
                    a.stopped = !1
                }
...
!function (t) {
    t.fn.mDatatable = t.fn.mDatatable || {}, t.fn.mDatatable.checkbox = function (e, a) {
        var n = {selectedAllRows: !1, selectedRows: [], unselectedRows: [], init: function () {
...
var mLayout = function () {
    ...
    return{init: function () {
            ...
            a = mUtil.get("m_header"), o = {offset: {}, minimize: {}}, "minimize" == mUtil.attr(a, "m-minimize-mobile") ? (o.minimize.mobile = {}, o.minimize.mobile.on = "m-header--minimize-on", o.minimize.mobile.off = "m-header--minimize-off") : o.minimize.mobile = !1, "minimize" == mUtil.attr(a, "m-minimize") ? (o.minimize.desktop = {}, o.minimize.desktop.on = "m-header--minimize-on", o.minimize.desktop.off = "m-header--minimize-off") : o.minimize.desktop = !1, (e = mUtil.attr(a, "m-minimize-offset")) && (o.offset.desktop = e), (e = mUtil.attr(a, "m-minimize-mobile-offset")) && (o.offset.mobile = e), new mHeader("m_header", o), n = new mOffcanvas("m_header_menu", {overlay: !0, baseClass: "m-aside-header-menu-mobile", closeBy: "m_aside_header_menu_mobile_close_btn", toggleBy: {target: "m_aside_header_menu_mobile_toggle", state: "m-brand__toggler--active"}}), t = new mMenu("m_header_menu", {submenu: {desktop: "dropdown", tablet: "accordion", mobile: "accordion"}, accordion: {slideSpeed: 200, expandAll: !1}}), $("#m_aside_header_topbar_mobile_toggle").click(function () {
                ...
                t.showProgress(), $.ajax({url: "https://keenthemes.com/metronic/themes/themes/metronic/dist/preview/inc/api/quick_search.php", data: {query: t.query}, dataType: "html", success: function (e) {
            ...
            var n, i, l, r, s;
            n = mUtil.get("m_aside_left"), i = mUtil.hasClass(n, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {baseClass: i, overlay: !0, closeBy: "m_aside_left_close_btn", toggleBy: {target: "m_aside_left_offcanvas_toggle", state: "m-brand__toggler--active"}}), r = mUtil.get("m_ver_menu"), s = "1" === mUtil.attr(r, "m-menu-dropdown") ? "dropdown" : "accordion", "1" === mUtil.attr(r, "m-menu-scrollable") && (l = {height: function () {
                    if (mUtil.isInResponsiveRange("desktop"))
                        return mUtil.getViewPort().height - parseInt(mUtil.css("m_header", "height"))
                }}), e = new mMenu("m_ver_menu", {scroll: l, submenu: {desktop: {default: s, state: {body: "m-aside-left--minimize", mode: "dropdown"}}, tablet: "accordion", mobile: "accordion"}, accordion: {autoScroll: !1, expandAll: !1}}), 0 !== $("#m_aside_left_minimize_toggle").length && (o = new mToggle("m_aside_left_minimize_toggle", {target: "body", targetState: "m-brand--minimize m-aside-left--minimize", togglerState: "m-brand__toggler--active"})).on("toggle", function (a) {
...
var mQuickSidebar = function () {
    var t = $("#m_quick_sidebar"), e = $("#m_quick_sidebar_tabs"), a = t.find(".m-quick-sidebar__content"), n = function () {
        var a, n, o, i;
        a = mUtil.find(mUtil.get("m_quick_sidebar_tabs_messenger"), ".m-messenger__messages"), n = $("#m_quick_sidebar_tabs_messenger .m-messenger__form"), mUtil.scrollerInit(a, {disableForMobile: !0, resetHeightOnDestroy: !1, handleWindowResize: !0, height: function () {
                return t.outerHeight(!0) - e.outerHeight(!0) - n.outerHeight(!0) - 120
            }}), (o = mUtil.find(mUtil.get("m_quick_sidebar_tabs_settings"), ".m-list-settings")) && mUtil.scrollerInit(o, {disableForMobile: !0, resetHeightOnDestroy: !1, handleWindowResize: !0, height: function () {
                return mUtil.getViewPort().height - e.outerHeight(!0) - 60
            }}), (i = mUtil.find(mUtil.get("m_quick_sidebar_tabs_logs"), ".m-list-timeline")) && mUtil.scrollerInit(i, {disableForMobile: !0, resetHeightOnDestroy: !1, handleWindowResize: !0, height: function () {
                return mUtil.getViewPort().height - e.outerHeight(!0) - 60
            }})
    };
    return{init: function () {
