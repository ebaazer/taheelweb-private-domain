...
var KTUppy = function () {
    ...
    var initUppy1 = function () {
        ...
        var ministry_pointer_items_id = document.getElementById("ministry_pointer_items_id");
        ...
        var options = {
            ...
            height: 470,
            metaFields: [
                {id: 'name', name: 'Name', placeholder: 'file name', ministry_pointer_items_id: ministry_pointer_items_id},
        ...
        uppyDashboard.use(XHRUpload, {endpoint: baseurl+'ministry/ministry_upload_files/'});
