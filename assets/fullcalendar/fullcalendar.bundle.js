        ...
        function TimeGridView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            _this.renderHeadIntroHtml = function () {
                ...
                if (_this.opt('weekNumbers')) {
                    ...
                    return '' +
                        '<th style="background-color: #ffffff !important;" class="fc-axis fc-week-number ' + theme.getClass('widgetHeader') + '" ' + _this.axisStyleAttr() + '>' +
                        core.buildGotoAnchorHtml(// aside from link, important for matchCellWidths
                    ...
                    return '<th class="fc-axis ' + theme.getClass('widgetHeader') + '" ' + _this.axisStyleAttr() + ' style="background-color: #ffffff !important;" ></th>';
                }
            };
