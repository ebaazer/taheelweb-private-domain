            ...
            $(form).ajaxSubmit({
                ...
                success: function () {
                    ...
                    if ($('.alert-error').length == 0) {
                        ...
                        setTimeout(function () {
                            window.location.href = baseurl + "home/send_ok"; // استبدلها بالرابط المطلوب
                        }, 300); // مهلة 2 ثانية قبل الانتقال
                    }
                }
            });
        }
            ...
            $(form).ajaxSubmit({
                ...
                success: function () {
                    ...
                    if ($('.alert-error').length == 0) {
                        ...
                        // **إعادة التوجيه إلى صفحة أخرى بعد النجاح**
                        setTimeout(function () {
                            window.location.href = baseurl + "home/booking_ok"; // استبدلها بالرابط المطلوب
                        }, 500); // مهلة 2 ثانية قبل الانتقال
                    }
                }
            });
        }
