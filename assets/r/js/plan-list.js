(function (window, Ractive, moment) {
    ...
    var plan = new Ractive({
        ...
        addNewStep: function (newGoal) {
            ...
            newGoal.assessment_case_id = this.get("plan.assessment_case_id");
            newGoal.student_id = this.get("plan.student_id");
            newGoal.step_measure = newGoal.step_name;
            
            var stepProgress = _this.get('STANDARD_GROUP.' + newGoal.standard_group_no)[1].id;
            newGoal.step_progress = stepProgress;
