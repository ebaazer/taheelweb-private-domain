    ...
    var assessment = new Ractive({
        ...
        onApproveAssessment: function (entry) {
            ...
            var newEntry = {
                ...
                assessment_taheelweb: entry.assessment_taheelweb,
                allow_use: entry.allow_use
            };
        ...
        mapStep: function (step) {
            return {
                ...
                educational_training: step.educational_training,
                lesson_prep: step.lesson_prep,
                enforcement_method: step.enforcement_method,
                assess_method: step.assess_method,
        ...
        parseAssessment: function (content) {
            ...
            var goals = targetLines.filter(function (line) {
                ...
                var step = {
                    ...
                    //تعديلات اباء
                    tools_used: items[12] || '',
                    educational_training: items[13] || '',
                    lesson_prep: items[14] || '',
                    enforcement_method: items[15] || '',
                    assess_method: items[16] || '',
                    ...
                    goalKeys.forEach(function (goalKey) {
                        ...
                        gSteps.forEach(function (step) {
                            ...
                            rawSteps.push({
                                ...
                                // discarded
                                evaluation_mechanism: step.evaluation_mechanism,
                                importance_goal: step.importance_goal,
                                special_considerations: step.special_considerations,
                                
                                special_code: step.special_code
                            });
                        });
                    });
                });
