(function() {
    ...
    var ractive = new Ractive({
        ...
        newRoleSelect: function() {
            ...
            var rolePermissionURL = baseUrl + "user_permission/api_role_permission/" + jobTitleId;
            var rawPermissionURL = baseUrl + "user_permission/api_role_raw_permissions";
        ...
        showPermission: function(title, list) {
            ...
            var url = baseUrl + "user_permission/api_set_role_permission/" + employeeId;
