(function () {
    ...
    var specialistSchedule = new Ractive({
        ...
        rawToEvent: function (rawEvent) {
            ...
            var _this = this;
            //console.log(+rawEvent.day_id);
            var day = +rawEvent.day_id;
            if(day == 6) {
                day = -1;
            }
            var baseDate = moment().day("Sunday").add(day, 'days').format("YYYY-MM-DD");
            //var baseDate = moment().day(0).add(+rawEvent.day_id, 'days').format("YYYY-MM-DD");
        ...
        renderCalendar: function (schedule) {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                editable: false, // تعطيل السحب والنقل
                ...
                eventStartEditable: false, // السماح نقل الأحداث
                eventDurationEditable: false, // السماح بتغيير المدة الزمنية
