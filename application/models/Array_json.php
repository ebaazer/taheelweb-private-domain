...
class Array_json extends CI_Model {
    ...
    function array_json($array_json = "", $by_field = "") {

        include(APPPATH . 'models/class-list-util.php');

        $data = $alldata = json_decode($array_json);
        ...
        $field = !empty($datatable['sort']['field']) ? $datatable['sort']['field'] : $by_field;
