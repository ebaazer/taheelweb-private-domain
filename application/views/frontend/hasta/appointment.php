    ...
    <div class="container">
        <div class="section-title section-title--style-1 text-center mb-3">
            <h3 class="heading heading-2 strong-400">
                <?php echo $this->lang->line('make_an_appointment');?>
            </h3>
                ...
                <form class="form-default" role="form"
                    ...
                    <div class="form-group">
                        <div class="checkbox checkbox-inline">
                            ...
                            <label for="radioExample_4a">
                                <?php echo $this->lang->line('new_patient');?>
                            </label>
                        </div>
                        <div class="checkbox checkbox-inline">
                            ...
                            <label for="radioExample_4b">
                                <?php echo $this->lang->line('old_patient');?>
                            </label>
                        </div>
                    </div>
                    ...
                    <div id="old_patient">
                        <div class="form-group">
                            <label for="" class="text-uppercase  c-gray-light">
                                <?php echo $this->lang->line('patient_code');?>
                            </label>
                            <span id="code_error" style="font-size: 12px; color: #d50000;
                                margin-left: 15px;">
                                <?php echo $this->lang->line('invalid_patient_code');?>
                            </span>
                            ...
                            <a href="<?php echo site_url('login');?>" target="_blank">
                                <?php echo $this->lang->line('log_in_to_patient_account_to_see_your_code');?>
                            </a>
                        </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="department_id" id="dept_select"
                            ...
                            <option value="0"><?php echo $this->lang->line('select_a_department');?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div id="doctor_list">
                            ...
                            <?php } else { ?>
                                ...
                                value="<?php echo $this->lang->line('select_a_department_first');?>" disabled>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control no-resize" rows="5" name="message"
                                  placeholder="<?php echo $this->lang->line('your_message_to_the_doctor');?>"></textarea>
                    </div>
                    ...
                    <button type="submit" class="btn btn-styled btn-base-1"
                        ...
                        <i class="fa fa-calendar mr-1"></i> <?php echo $this->lang->line('book_now');?>
                    </button>
                </form>
            </div>
        </div>
