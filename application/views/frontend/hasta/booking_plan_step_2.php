...
if (in_array($string, $day_1_section)) {
    ...
    $is_day = $day_4_date;
    $name_day = "Wednesday";
    $is_book = $this->db->get_where('booking_plan', array('date_m' => $day_4_date, 'section_id' => $enroll_data->section_id))->row();
}
else {
                ...
                <div class="smart-forms bmargin">
                    <center>
                        <h3 class="love-ya-like-a-sister">
                            Your appointment to discuss the plan will be on
                            <br />
                            <?php echo $name_day . ' ' . $is_day . ' '; ?>

                        </h3>
                    </center>
                    <p class="msg-success">
                       Choose the appropriate time from the list of available times.
                    </p>
                    ...
                    <form>
                        ...
                        <div>
                            ...
                            if ($is_book_93 > 0) {
                                $e93 = '09:30 A.M' . ' - ' . "Booked";
                            } else {
                                $e93 = '09:30 A.M';
                            }

                            if ($is_book_10 > 0) {
                                $e10 = '10:00 A.M' . ' - ' . "Booked";
                            } else {
                                $e10 = '10:00 A.M';
                            }

                            if ($is_book_103 > 0) {
                                $e103 = '10:30 A.M' . ' - ' . "Booked";
                            } else {
                                $e103 = '10:30 A.M';
                            }

                            if ($is_book_11 > 0) {
                                $e11 = '11:00 A.M' . ' - ' . "Booked";
                            } else {
                                $e11 = '11:00 A.M';
                            }

                            if ($is_book_113 > 0) {
                                $e113 = '11:30 A.M' . ' - ' . "Booked";
                            } else {
                                $e113 = '11:30 A.M';
                            }
                            ?>
                            ...
                            <div class="section">
                                <label class="field select">
                                    <select id="time_m" name="time_m">
                                        <option value="00:00">Available Appointments</option>
