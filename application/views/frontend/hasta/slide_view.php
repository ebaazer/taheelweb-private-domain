<nav class="st-menu st-effect-1" id="menu-1">
    ...
    <div class="doctor-details">
        <ul>
            <li class="clearfix">
                <strong class="float-left"><?php echo $this->lang->line('phone');?> : </strong> <span class="float-left"><?php echo $doctor->phone;?></span>
            </li>
            <li class="clearfix">
                <strong class="float-left"><?php echo $this->lang->line('email');?> : </strong> <span class="float-left"><?php echo $doctor->email;?></span>
            </li>
            <li class="clearfix">
                <strong class="float-left"><?php echo $this->lang->line('address');?> : </strong> <span class="float-left"><?php echo $doctor->address;?></span>
            </li>
            <li class="clearfix">
                <strong class="float-left"><?php echo $this->lang->line('degrees');?> : </strong> <span class="float-left">M.D. of Medicine</span>
            </li>
        </ul>
        <div class="doctor-description">
            <h5><?php echo $this->lang->line('profile');?></h5>
            <p>
    ...
    <div class="appointment-btn doctor-book">
        <a href="<?php echo site_url('home/appointment/' . $doctor->doctor_id);?>" class="btn btn-styled btn-base-1 btn-outline btn-icon-left">
            <i class="fa fa-calendar"></i><?php echo $this->lang->line('book_appointment');?>
        </a>
    </div>
