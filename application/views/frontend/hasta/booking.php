...
<section>
    <div class="header-inner three less-margin-2">
        <div class="inner text-center">
            <h2 class="title-2 padding-1 text-white raleway"><?php echo $this->lang->line('Booking'); ?></h2>
            <h5 class="text-white raleway">...</h5>
        </div>
        <div class="overlay bg-opacity-5"></div>
        <img src="<?php echo base_url(); ?>assets/frontend/hasta/images/sliders/2.jpg" alt="" class="img-responsive"/> </div>
</section>
<div class="clearfix"></div>
<!-- end header inner -->
