            ...
            <div class="col-md-12">
                <div class="single-album-wrapper">
                    ...
                    <div class="picture-grid" style="text-align: center; direction: rtl;">
                        ...
                        $dir = '/mnt/taheelweb_volume/uploads/' . $client_id . '/gallery_images/' . $gallery_id;

                        if (!is_dir($dir)) {
                            echo "❌ المجلد غير موجود: $dir<br>";
                            return;
                        }
                        ...
                        foreach ($map as $value) {
                            ...
                            if (in_array($ext, ['jpg', 'jpeg', 'png', 'gif'])) {
                                $src = $folder . "/gallery_images/$gallery_id/$value";
                                ?>
                                <a href="<?= $src ?>" target="_blank">
                                    <div class="grid-box">
                                        <img style="padding: 12px; border-radius: 50px;" src="<?= $src ?>" />
                                    </div>
                                </a>
                                <?php
                            }
