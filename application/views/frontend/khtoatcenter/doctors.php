        ...
        <div class="row py-3">
            <div class="col-lg-12">
                <h1 class="heading text-uppercase c-white">
                    <?php echo (isset($department)) ? $this->lang->line('doctors_of').' '.$department->name.' '. $this->lang->line('department') :
                        $this->lang->line('doctors_of_all_departments');?>
                </h1>
                    ...
                    <div class="sidebar-object">
                        <div class="section-title section-title--style-1">
                            <h3 class="section-title-inner heading-sm strong-500">
                                <?php echo $this->lang->line('doctors_of');?>
                            </h3>
                        </div>
                        ...
                        <ul class="categories categories--style-2">
                            <li class="<?php if(!(isset($department))) echo 'active';?>">
                                <a href="<?php echo site_url('home/doctors');?>">
                                    <?php echo $this->lang->line('all_departments');?>
                                </a>
                            </li>
                                            ...
                                            <div class="mask">
                                                <div class="view-buttons">
                                                    <span class="view-buttons-inner text-center appointment-btn">
                                                        <a href="javascript:;" id="<?php echo site_url('home/get_doctor_details/' . $row['doctor_id']);?>"
                                                            class="btn btn-styled btn-base-1 btn-outline btn-icon-left btn-st-trigger" 
                                                                data-effect="st-effect-1">
                                                            <i class="fa fa-user-md"></i> &nbsp;<?php echo $this->lang->line('profile');?>
                                                        </a>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="block-content w-100">
                                        <div class="block-body py-2 px-0">
                                            <h3 class="heading heading-5 strong-500">
                                                <a href="javascript:;" class="btn-st-trigger" data-effect="st-effect-1"
                ...
                <div class="row align-items-center">
                    <div class="col-lg-9">
                        <div class="text-center text-lg-left">
                            ...
                            <?php echo $this->lang->line('get_in_touch_with_our_specialists');?>
                            </h1>
                        </div>
                    </div>
